...
output_path1 = '/mnt/nfsdrives/shared/behjat/output_data/imgNet_v01/baseData_25_color.mat'
output_path2 = '/mnt/nfsdrives/shared/behjat/output_data/imgNet_v01/baseData_25_color_pred_prob.mat'
attribVocabulary = dict(blue=0, brown=1, gray=2, yellow=3, pink=4, black=5, violet=6, orange=7, green=8, white=9, red=10)
numClasses = 11
dim = 25
